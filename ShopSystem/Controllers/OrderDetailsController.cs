...
namespace ShopSystem.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.OrderDetail.Include(o => o.Product).Include(o => o.SalesOrder);
        ...
        public async Task<IActionResult> Create([Bind("OrderDetailId,SalesOrderId,ProductId,Quantity,Price,UOM,Discount")] OrderDetail orderDetail)
        {
            ...
            ViewData["SalesOrderId"] = new SelectList(_context.Set<SalesOrder>(), "SalesOrderId", "SalesOrderId", orderDetail.SalesOrderId);
            return View(orderDetail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderDetailId,SalesOrderId,ProductId,Quantity,Price,UOM,Discount")] OrderDetail orderDetail)
        {
